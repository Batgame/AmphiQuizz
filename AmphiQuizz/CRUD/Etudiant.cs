...
namespace AmphiQuizz
{
    ...
    {
        /// <remarks>
        /// Propriété contenant un identifiant pour étudiant
        /// </remarks>
        private int idEtu;
        ...
        /// <remarks>
        /// Propriété contenant un chemin de photo
        /// </remarks>
        ...
        /// <remarks>
        /// Propriété contenant une liste de notes
        /// </remarks>
        /// 
        ...
        public ObservableCollection<Etudiant> FindAll()
        {
            ...
            try
            {
                ...
                {
                    reader = access.getData("select e.idEtu, e.idgroupe, g.libellegroupe, e.nometu, e.prenometu, e.photoetu from [IUT-ACY\\genodb].ETUDIANT e join [IUT-ACY\\genodb].GROUPE g on g.idgroupe = e.idgroupe order by e.nometu;");
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
